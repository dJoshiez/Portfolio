  ...
  return (
    ...
    >
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
        ...
        I love working on big projects to continuously improve them. I also focus on increasing traffic through search engines and social media platforms. Let's collaborate to elevate your project!
        </p>
      </div>
    </div>
  );
